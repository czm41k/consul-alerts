...
[![Join the chat at https://gitter.im/czm41k/consul-alerts](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/czm41k/consul-alerts?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
...
Stable release are [here](https://github.com/czm41k/consul-alerts/releases).
...
```
$ go get github.com/czm41k/consul-alerts
$ go install
```
